<div class="w-1/4 bg-gray-800 p-6 min-h-screen">
    <ul class="space-y-4">
        <li><a href="/dwp/home" class="block py-2 px-3 rounded text-gray-300 hover:bg-gray-700 hover:text-white">Back to Home</a></li>
