<div class="fixed left-0 top-0 w-1/6 bg-gray-800 p-6 min-h-screen">
    <ul class="space-y-4">
        ...
        <li><a href="?section=showings" class="block py-2 px-3 rounded text-gray-300 hover:bg-gray-700 hover:text-white">Showings</a></li>
