...
$genres = $genreController->getAllGenresByMovieId($movie->getMovieId());
...
<body class="max-w-[90rem] w-[100%] mx-auto mt-[4.5rem] px-[6.25rem] font-sans bg-[#0d0101] text-white m-0 p-[2vw]">
  ...
  <div class="movie-poster-container">
    ...
    <div class="ml-[20px]">
      ...
      <div>
        <span class="font-bold">Cast: </span><?php
  ...
  <div class="bg-yellow-900 text-white p-4 ml-2 mt-6 rounded-[1.5rem]">
